...
static void inform_play_transition_from_output(Output::output_state_t state) {
  service_lock();
  switch (state) {
    case Output::output_state_t::PlaybackStopped:
      replace_transport_uri_and_meta("", "");
      replace_current_uri_and_meta("", "");
      change_transport_state(TRANSPORT_STOPPED);
      break;

    case Output::output_state_t::StartedNextStream: {
...
struct service *upnp_transport_get_service(void) {
  ...
  static struct var_meta transport_var_meta[] = {
      {TRANSPORT_VAR_TRANSPORT_STATE, "TransportState", "STOPPED", EV_NO,
       DATATYPE_STRING, transport_states, NULL},
      {TRANSPORT_VAR_TRANSPORT_STATUS, "TransportStatus", "OK", EV_NO,
       DATATYPE_STRING, transport_stati, NULL},
      {TRANSPORT_VAR_PLAY_MEDIUM, "PlaybackStorageMedium", "UNKNOWN", EV_NO,
       DATATYPE_STRING, media, NULL},
      ...
      {TRANSPORT_VAR_PLAY_MEDIA, "PossiblePlaybackStorageMedia",
       "NETWORK,UNKNOWN", EV_NO, DATATYPE_STRING, NULL, NULL},
      {TRANSPORT_VAR_REC_MEDIA, "PossibleRecordStorageMedia", "NOT_IMPLEMENTED",
       EV_NO, DATATYPE_STRING, NULL, NULL},
      {TRANSPORT_VAR_CUR_PLAY_MODE, "CurrentPlayMode", "NORMAL", EV_NO,
       DATATYPE_STRING, playmodi, NULL},
      {TRANSPORT_VAR_TRANSPORT_PLAY_SPEED, "TransportPlaySpeed", "1", EV_NO,
       DATATYPE_STRING, playspeeds, NULL},
      {TRANSPORT_VAR_REC_MEDIUM_WR_STATUS, "RecordMediumWriteStatus",
       "NOT_IMPLEMENTED", EV_NO, DATATYPE_STRING, rec_write_stati, NULL},
      {TRANSPORT_VAR_CUR_REC_QUAL_MODE, "CurrentRecordQualityMode",
       "NOT_IMPLEMENTED", EV_NO, DATATYPE_STRING, rec_quality_modi, NULL},
      {TRANSPORT_VAR_POS_REC_QUAL_MODE, "PossibleRecordQualityModes",
       "NOT_IMPLEMENTED", EV_NO, DATATYPE_STRING, NULL, NULL},
      {TRANSPORT_VAR_NR_TRACKS, "NumberOfTracks", "0", EV_NO, DATATYPE_UI4,
       NULL, &track_nr_range}, /* no step */
      {TRANSPORT_VAR_CUR_TRACK, "CurrentTrack", "0", EV_NO, DATATYPE_UI4, NULL,
       &track_range},
      {TRANSPORT_VAR_CUR_TRACK_DUR, "CurrentTrackDuration", kZeroTime, EV_NO,
       DATATYPE_STRING, NULL, NULL},
      {TRANSPORT_VAR_CUR_MEDIA_DUR, "CurrentMediaDuration", "", EV_NO,
       DATATYPE_STRING, NULL, NULL},
      {TRANSPORT_VAR_CUR_TRACK_META, "CurrentTrackMetaData", "", EV_NO,
       DATATYPE_STRING, NULL, NULL},
      {TRANSPORT_VAR_CUR_TRACK_URI, "CurrentTrackURI", "", EV_NO,
       DATATYPE_STRING, NULL, NULL},
      {TRANSPORT_VAR_AV_URI, "AVTransportURI", "", EV_NO, DATATYPE_STRING, NULL,
       NULL},
      {TRANSPORT_VAR_AV_URI_META, "AVTransportURIMetaData", "", EV_NO,
       DATATYPE_STRING, NULL, NULL},
      {TRANSPORT_VAR_NEXT_AV_URI, "NextAVTransportURI", "", EV_NO,
       DATATYPE_STRING, NULL, NULL},
      {TRANSPORT_VAR_NEXT_AV_URI_META, "NextAVTransportURIMetaData", "", EV_NO,
       DATATYPE_STRING, NULL, NULL},
      {TRANSPORT_VAR_REL_TIME_POS, "RelativeTimePosition", kZeroTime, EV_NO,
       DATATYPE_STRING, NULL, NULL},
      ...
      {TRANSPORT_VAR_LAST_CHANGE, "LastChange",
       "<Event xmlns=\"urn:schemas-upnp-org:metadata-1-0/AVT/\"/>", EV_YES,
       DATATYPE_STRING, NULL, NULL},
      {TRANSPORT_VAR_AAT_SEEK_MODE, "A_ARG_TYPE_SeekMode", "TRACK_NR", EV_NO,
       DATATYPE_STRING, aat_seekmodi, NULL},
      {TRANSPORT_VAR_AAT_SEEK_TARGET, "A_ARG_TYPE_SeekTarget", "", EV_NO,
       DATATYPE_STRING, NULL, NULL},
      {TRANSPORT_VAR_AAT_INSTANCE_ID, "A_ARG_TYPE_InstanceID", "0", EV_NO,
